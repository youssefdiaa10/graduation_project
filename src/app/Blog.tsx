    ...
    <>
        <motion.div variants={slideInFromTop(.5)} className="ml-7 my-10">
            <div className="flex justify-between items-baseline">
                <motion.h1 variants={slideInFromRight(1)} className="text-[27px] my-3 mx-5 font-bold text-main">Geography</motion.h1>
        ...
        <motion.div variants={slideInFromTop(.5)} className="ml-7 my-10">
            <div className="flex justify-between items-baseline">
                <motion.h1 variants={slideInFromRight(1)} className="text-[27px] my-3 mx-5 font-bold text-main">French</motion.h1>
        ...
        <motion.div variants={slideInFromTop(.5)} className="ml-7 my-10">
            <div className="flex justify-between items-baseline">
                <motion.h1 variants={slideInFromRight(1)} className="text-[27px] my-3 mx-5 font-bold text-main">Novel</motion.h1>
